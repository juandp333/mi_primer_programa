...
pokemon_elegido = input("¿Contra que Pokemon quieres combatir? (Squirtle / Charmander / Bolbasor)")
...
elif pokemon_elegido == "Bolbasor":
    vida_enemigo =100
    nombre_pokemon = "Bolbasor"
    ataque_pokemon = 10
